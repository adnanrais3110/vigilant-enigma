            ...
            <tr class="thead-dark text-center">
              <form action="" method="post">
                ...
                <td>
                  ...
                  <a href="detail.php?gambar=<?= $row["gambar_sabun_muka"] ?>&product_nama=<?= $row["nama_sabun_muka"]  ?>&product_bahan=<?= $row["bahan_sabun_muka"] ?>&product_kegunaan=<?= $row["kegunaan_sabun_muka"]  ?>&product_harga=<?= $row["harga_sabun_muka"] ?>" class="btn btn-sm text-white bg-danger">Detail</a>
