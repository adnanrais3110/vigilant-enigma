...
<body>
  ...
  <head>
    ...
    <title>Cek pesanan - AdnanRise personal group</title>
    ...
    <div class="container">
      <main>
        <div class="py-5 text-center">
          <img class="d-block mx-auto mb-4" src="../asset/img/kontol.png" width="100" height="100">
          <h2>Check Pesanan</h2>
          <p class="lead">Kami akan memproses pesanan saat sudah +5 Jam dari pesanan di buat,untuk membatalkan pesanan Silahkan hubungi
            <span><a href="https://api.whatsapp.com/send?phone=6285760680164" target="_blank">Atmin</a></span>. Jika lebih dari ketentuan, pesanan tidak akan dibatalkan
          </p>
        </div>
      ...
      <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1 text-danger">&copy; AdnanRise</p>
