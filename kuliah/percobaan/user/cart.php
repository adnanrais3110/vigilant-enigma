...
if (isset($_GET['delete_all'])) {
   ...
   echo "
         <script>
            alert('semua produk berhasil diubah!!');
            document.location.href = 'cart.php'
         </script>
        ";
}
         ...
         <table>
            ...
            <tbody>
               ...
               ?>
                     ...
                     <tr>
                        <td><img src="<?php echo $fetch_cart['gambar_sabun_muka_cart']; ?>" height="100" alt=""></td>
                        <td><?php echo $fetch_cart['nama_sabun_muka_cart']; ?></td>
                        <td>Rp.<?php echo number_format($fetch_cart['harga_sabun_muka_cart']); ?>/-</td>
                        <td>
                        ...
                        <?php $sub_total = $fetch_cart['harga_sabun_muka_cart'] * $fetch_cart['quantity']; ?>
