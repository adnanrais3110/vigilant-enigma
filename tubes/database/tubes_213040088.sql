...
CREATE TABLE `cart` (
  ...
  `nama_sabun_muka_cart` varchar(255) NOT NULL,
  `bahan_sabun_muka_cart` text NOT NULL,
  `kegunaan_sabun_muka_cart` text NOT NULL,
  `harga_sabun_muka_cart` int(11) NOT NULL,
  `gambar_sabun_muka_cart` varchar(255) NOT NULL,
...
(1, 'Adiya', 'adnan', '$2y$10$j1sTiKfWrJjcqYLQv9IbHexJ/EZr3dcCU/eD.gCw/CK5G8QJ8Hv9C', 'adnanrais@gmail.com', 'admin', '', '', '', '', '', ''),
...
ALTER TABLE `data_sabun_muka`
  ADD PRIMARY KEY (`id_sabun_muka`);
ALTER TABLE `data_sabun_muka` ADD FULLTEXT KEY `bahansabunmuka` (`bahan_sabun_muka`);
ALTER TABLE `data_sabun_muka` ADD FULLTEXT KEY `kegunaansabunmuka` (`kegunaan_sabun_muka`);
--
...
ALTER TABLE `data_sabun_muka`
  MODIFY `id_sabun_muka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
