				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<ul>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="floatingInput" name="nama_sabun_muka" required placeholder="Nama Sabun_muka">
							<label for="floatingInput">Nama Sabun :</label>
						</div>
						<div class="mb-3">
							<label for="bahan_sabun" class="form-label">Bahan Sabun:</label>
							<textarea name="bahan_sabun_muka" id="bahan_sabun_muka" class="form-control" rows="5" cols="50" required></textarea>
						</div>
						<div class="mb-3">
							<label for="kegunaan_sabun" class="form-label">Kegunaan Sabun :</label>
							<textarea name="kegunaan_sabun_muka" id="kegunaan_sabun_muka" class="form-control" rows="4" cols="50" required></textarea>
						</div>
						<div class="form-floating mb-3">
							<input type="number" class="form-control" id="floatingInput" name="harga_sabun_muka" required placeholder="Harga Sabun" style="width: 250px;">
						...
						<div class="mb-3">
							...
							<input type="file" name="gambar_sabun_muka" id="gambar_sabun_muka" onchange="previewimg()">
						</div>
						<br>
						<div class="mb-3">
